...
public class SlimClothingModel extends BipedEntityModel<AbstractClientPlayerEntity> {
	private ModelPart clothed_l_arm, clothed_r_arm;
	private final boolean thinArms;
	public SlimClothingModel(ModelPart root, boolean thinArms) {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData right_armCloth = right_arm.addChild("right_arm", ModelPartBuilder.create().uv(40, 16).cuboid(-12.0F, -2.0F, -2.0F, 3.0F, 12.0F, 4.0F, new Dilation(0.01F))
				.uv(40, 32).cuboid(-12.0F, -2.0F, -2.0F, 3.0F, 12.0F, 4.0F, new Dilation(0.25F)), ModelTransform.pivot(10.0F, 0.0F, 0.0F));

		ModelPartData left_arm = root.getChild(EntityModelPartNames.LEFT_ARM);
		ModelPartData left_armCloth = left_arm.addChild("left_arm", ModelPartBuilder.create().uv(32, 48).cuboid(9.0F, -2.0F, -2.0F, 3.0F, 12.0F, 4.0F, new Dilation(0.01F))
				.uv(48, 48).cuboid(9.0F, -2.0F, -2.0F, 3.0F, 12.0F, 4.0F, new Dilation(0.25F)), ModelTransform.pivot(-10.0F, 0.0F, 0.0F));
